...
import static FrontClientes.frmClientsAdmin.*;

public class BackClienteAdmin {

    ClsConexion CON;
    Connection CN;

    public BackClienteAdmin() {
    ...
    public void ModificarCliente() {
        ...
        if (Dni.equals("")) {
            ...
            try {
                ...
                if (!RS.next()) {
                    Limpiare();
                    JOptionPane.showMessageDialog(null, "¡Error! el Cliente NO existe en la BD");
                } else {
        ...
        if (!Dni.equalsIgnoreCase("")) {
            try {
                ...
                if (RS.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "¡¡No existe el Cliente en la base de datos!!", "¡Error!", JOptionPane.ERROR_MESSAGE);
                    txtDni.setText("");
                    txtDni.requestFocus();
                }
            } catch (Exception e) {
            ...
            JOptionPane.showMessageDialog(null, "Debe ingresar un Dni para validar", "¡Error!", JOptionPane.ERROR_MESSAGE);
            lblErrorDni.setVisible(false);
            txtDni.requestFocus();
        }
    }
