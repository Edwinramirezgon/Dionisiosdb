...
import BackendCompras.BackCompras;

public class frmCompras extends javax.swing.JFrame {

    BackCompras ObjCompras;

    public frmCompras() {
        ObjCompras = new BackCompras();
        initComponents();
        ...
        ObjCompras.Limpiar();
        ObjCompras.CargarListaEmpresas();
    ...
    private void txtNombreKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreKeyReleased
       ObjCompras.BuscarProductoNombre();
    ...
    private void txtCodigoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoKeyReleased
        ObjCompras.BuscarProductoCodigo();
